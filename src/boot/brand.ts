...
export const logo = `<svg viewBox="0 0 310 185" aria-label="DataRocks" role="img">${paths}<text x="165" y="174" text-anchor="middle" font-family="MiSans,sans-serif" font-size="16" font-weight="700" letter-spacing="22">DataRocks</text></svg>`;
